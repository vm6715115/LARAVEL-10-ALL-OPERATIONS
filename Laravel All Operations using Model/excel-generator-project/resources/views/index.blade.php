...
<div id="main-content">
    ...
    <form class="post-form" action="{{route('exportStudent')}}" method="GET">
        ...
        <input style="border:1px soid green; background-color:green;color:white;text-decoration:none; padding:10px;" type="submit" name="submit" value="Export Excel File">
    </form>
