...
class StudentController extends Controller
{
    ...
    {
        $student = DB::table('class_data')->get();
        return view('add',['data' => $student]);
    ...
    {
        $student = DB::table('student_data')->join('class_data','student_data.class','=','class_data.cid')->get();
    ...
    {
        $student = DB::table('student_data')->join('class_data','student_data.class','=','class_data.cid')->find($id);
    ...
    public function updatePage(string $id)
    {
        ...
        $student1 = DB::table('class_data')->get();
        return view('update',['data' => $student,'data1' => $student1]);
